...
class NativeObjectRecognitionService: ObjectRecognitionService {
    ...
    override fun initializeEmbedded(useXnnpack: Boolean, numThreads: Int): Boolean {
     ...
     */
    override fun processYuv420Rotated(
    ...
    override fun encodeLastJpeg(buf: ByteBuffer, quality: Int): Int =
